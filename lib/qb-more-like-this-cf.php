...
function mlt_render_meta_box($post) {
    $mlt1 = get_post_meta($post->ID, 'more_like_this_1', true);
    $mlt2 = get_post_meta($post->ID, 'more_like_this_2', true);
    ...
    ?>
    <p>
        <label for="mlt1">More Like This - 1</label><br>
        <input type="hidden" name="more_like_this_1" id="mlt1_hidden" value="<?php echo esc_attr($mlt1); ?>">
        <input type="text" id="mlt1" class="mlt-autocomplete" data-source="posts" data-target="#mlt1_hidden" value="<?php echo esc_attr($title1); ?>" autocomplete="off" style="width: 100%;">
    </p>
    <p>
        <label for="mlt2">More Like This - 2</label><br>
        <input type="hidden" name="more_like_this_2" id="mlt2_hidden" value="<?php echo esc_attr($mlt2); ?>">
        <input type="text" id="mlt2" class="mlt-autocomplete" data-source="posts" data-target="#mlt2_hidden" value="<?php echo esc_attr($title2); ?>" autocomplete="off" style="width: 100%;">
...
function mlt_save_meta_box_data($post_id) {
    ...
    $fields = ['more_like_this_1', 'more_like_this_2'];
