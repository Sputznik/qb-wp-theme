...
if( $cats_str && strlen( $shortcode_str ) > 0 ): ?>
  <div class="related-posts">
    <div class="container">
      <div class="row" style="display: flex; align-items: flex-end; justify-content: space-between; padding-left:27px; padding-right:27px;">
        <div style="flex:1;">
          <h2 class="headline" style="margin-bottom:0;">More like this</h2>
        </div>
        <div style="display: flex; align-items: flex-end;">
          ...
          ?>
          <a href="<?php echo esc_url($cat_link); ?>" class="subheadline" style="display: flex; align-items: flex-end; text-decoration:none; gap:6px;">
            <span>View All</span>
